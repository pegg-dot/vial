...
- Canonical graph and alias resolution
- Controlled source pilots
- Parser benchmarks, confidence calibration, corrections, freshness, and reliability
- Typo-tolerant deterministic search
...
- Personalized market home with transparent reasons
...
- Self-serve, eight-dimension seller onboarding
- Existing-profile and canonical product matching
- Shopify, WooCommerce, CSV, website, Stripe Connect, webhook, and MCP adapter boundaries
- Dry-run imports and seller review queues
- Product, batch, evidence, inventory, order, dispute, payout, support, analytics, health, team, and developer workspaces
- Scoped seller APIs and a real stdio MCP server
- Staff seller-readiness oversight
...
- Processor-neutral payment, tax, and fraud adapters
- Mock provider and Stripe Connect test/live boundary
- Hosted seller onboarding and capability synchronization
- Versioned seller, SKU, customer, jurisdiction, evidence, and merchant-model activation
- Direct and multi-seller charge models
- Prepared checkouts, Payment Element, signed event finalization, failure release, deduplication, and replay
- Provider intents, transfers, reserves, tax, fraud, underwriting, settlement, and reconciliation
- Seller and staff payment operating surfaces
...
- Laboratory onboarding, teams, permissions, quality posture, and method scope
- Test orders, sample kits, accessioning, and hash-chained custody
- Vendor-selected, customer-sealed, blind-purchase, and multi-source sampling models
- Structured runs and analytical results
- Versioned report issuance, supersession, correction, verification, and revocation
- Multidimensional batch passports with conflicts, limitations, and report history
- Laboratory REST APIs and proposal-only MCP
- Public, seller, laboratory, and staff operating surfaces
