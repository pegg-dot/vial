...
export default async function DeveloperPage() {
  ...
  return (
    <main className="mx-auto max-w-4xl px-5 py-14">
      ...
      <h1 className="mt-3 text-5xl font-semibold tracking-[-.06em]">Developer</h1>
      ...
      <section className="mt-8 overflow-hidden rounded-[24px] bg-[#111214] p-6 text-white">
        <p className="text-[11px] font-semibold uppercase tracking-[.16em] text-white/40">Quickstart</p>
        <h2 className="mt-3 text-xl font-semibold tracking-[-.03em]">Call the API</h2>
        <pre className="mt-4 overflow-x-auto rounded-2xl bg-black/40 p-4 text-xs leading-6 text-white/85"><code>{`curl -H "Authorization: Bearer vial_pk_…" \\
