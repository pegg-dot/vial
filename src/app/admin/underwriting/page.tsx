...
export default async function UnderwritingPage() {
  ...
  return <div>
    ...
    <p className="mt-3 max-w-3xl text-sm font-medium leading-6 text-[var(--muted)]">Processor capability is necessary but not sufficient. VIAL separately records seller underwriting, due requirements, risk tier, catalog scope, jurisdictions, and expiration.</p>
