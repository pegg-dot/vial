...
const schema=z.object({eventType:z.enum(["listing_viewed","listing_saved","listing_removed","comparison_created","comparison_updated","evidence_opened","saved_search_run","followed","unfollowed"]),subjectType:z.enum(["listing","compound","vendor","saved_search","comparison"]),subjectId:z.string().trim().min(1).max(160),metadata:z.record(z.string(),z.unknown()).optional()});
