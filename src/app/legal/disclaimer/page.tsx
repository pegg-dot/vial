...
export default function Page(){return <LegalPage eyebrow="Important boundary" title="Research and medical disclaimer" updated="Prototype notice · July 2026" sections={[
["No medical guidance","VIAL does not diagnose, treat, prevent, or recommend anything. It does not provide dosing, administration, reconstitution, injection, or product-use instructions."],
