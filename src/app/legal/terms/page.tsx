...
["Demo and Live records","Records are demo unless marked Live. Live records are aggregated from real public third-party sources (vendor pages, lab feeds) and are provided for information only — a listing is never an endorsement, a safety claim, or a recommendation to buy or use any product."],
