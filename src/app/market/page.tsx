      ...
      <section className="relative isolate overflow-hidden border-b-2 border-[#111214] bg-[#eafff7]">
        ...
        <div className="mx-auto max-w-[1320px] px-5 py-16 sm:px-8 sm:py-20">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-lg font-medium leading-8 text-[#111214]/70">Every listing from every vendor, side by side &mdash; price, lab test, batch, and availability. Listings are demo data unless marked Live.</p>
          </div>
        </div>
      </section>
