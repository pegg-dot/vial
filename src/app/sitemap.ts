...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const pages = [
    ...
    ["/research","weekly",.75], ["/passports","daily",.8], ["/labs","weekly",.75], ["/testing","weekly",.7], ["/updates","daily",.7], ["/compare","weekly",.6], ["/how-we-check","monthly",.7], ["/developers","monthly",.6],
    ["/operations","daily",.5], ["/signals","daily",.65], ["/about","monthly",.5], ["/help","monthly",.5],
    ["/status","daily",.4], ["/sell","monthly",.5], ["/legal/privacy","yearly",.2], ["/legal/terms","yearly",.2], ["/legal/disclaimer","yearly",.3],
  ] as const;
  return [
