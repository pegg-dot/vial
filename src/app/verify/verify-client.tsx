...
// The interactive half of /verify. It is split out from page.tsx because `metadata` may only be
// exported from a server component, and this whole surface is browser state.
