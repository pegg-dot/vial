 ...
 *
 * There is one admin page now, so there is no sidebar: just enough chrome to know where you are,
...
export function AdminShell({ role, principal, children }: { role: StaffRole; principal: Principal; children: React.ReactNode }) {
  return (
    <section className="mx-auto max-w-[1540px] px-4 py-6 sm:px-7 sm:py-8">
      <header className="ink hard mb-6 flex flex-wrap items-center justify-between gap-4 rounded-[18px] bg-[#111214] px-5 py-4 text-white">
