  ...
  return (
    <section className="mx-auto max-w-[1320px] px-5 pt-14 sm:px-8 sm:pt-16">
      <div className="mb-7">
        ...
        <p className="mt-3 max-w-2xl text-sm font-medium leading-6 text-[var(--muted)]">Discounts {vendorName} advertises publicly, captured with a source link. Informational only — VIAL doesn&rsquo;t sell or take a cut, and codes expire, so confirm at the source.</p>
      </div>
