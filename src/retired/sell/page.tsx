...
export const metadata: Metadata = { title: "Sell on VialGrade", description: "A guided, evidence-first seller onboarding workspace." };
...
export default function SellPage() {
  return <main className="min-h-screen bg-[#f7f7f4]">
    ...
    <section className="mx-auto max-w-7xl px-5 pb-24 pt-16 sm:px-8 lg:pt-24">
      <p className="text-[11px] font-bold uppercase tracking-[.2em] text-[#6d5dfc]">VialGrade for sellers</p>
      ...
      <p className="mt-7 max-w-2xl text-lg font-medium leading-8 text-[var(--muted)]">Import the catalog you already maintain, match products to VialGrade’s canonical market graph, connect batch evidence, and prepare one reviewable seller package.</p>
      ...
      <div className="mt-20 grid gap-5 md:grid-cols-3">{[
        ...
        { Icon: Sparkles, title: "Match", detail: "VialGrade proposes canonical compound and quantity mappings with visible confidence and alternatives." },
