...
import { pruneStackSlugs, splitWatchlist } from "@/lib/saved-stacks";
...
export async function getSavedStackSlugs(userId:string){return pruneStackSlugs(splitWatchlist(await getWatchlistKeys(userId)).stacks)}
