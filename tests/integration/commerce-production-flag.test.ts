...
describe("commerce production flag interlock", () => {
  beforeEach(() => { process.env.VIAL_PGLITE_MEMORY = "true"; delete (globalThis as { __vialDbPromise?: unknown }).__vialDbPromise; delete (globalThis as { __vialInternalSeedPromise?: unknown }).__vialInternalSeedPromise; });
