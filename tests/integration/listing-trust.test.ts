...
process.env.VIALGRADE_SESSION_SECRET = "listing-trust-test-secret-at-least-32-characters";
process.env.VIALGRADE_PRIVACY_HASH_SECRET = "listing-trust-privacy-secret-at-least-32-characters";
