...
process.env.VIAL_SESSION_SECRET = "price-history-test-secret-at-least-32-characters";
process.env.VIAL_PRIVACY_HASH_SECRET = "price-history-privacy-secret-at-least-32-characters";
