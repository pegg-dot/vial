...
process.env.VIALGRADE_SESSION_SECRET = "vendor-status-test-secret-at-least-32-characters";
process.env.VIALGRADE_PRIVACY_HASH_SECRET = "vendor-status-privacy-secret-at-least-32-characters";
